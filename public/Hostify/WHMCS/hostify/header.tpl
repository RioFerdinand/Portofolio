...
<div id="header-holder" class="{if $templatefile != 'homepage'}inner-header{else}main-header{/if}">
    <div class="bg-animation">
        <div class="graphic-show">
            <img class="fix-size" src="{{assetPath file='graphic1.png'}|replace:'/png/':'/images/'}" alt="">
            <img class="img img1" src="{{assetPath file='graphic1.png'}|replace:'/png/':'/images/'}" alt="">
            <img class="img img2" src="{{assetPath file='graphic2.png'}|replace:'/png/':'/images/'}" alt="">
            <img class="img img3" src="{{assetPath file='graphic3.png'}|replace:'/png/':'/images/'}" alt="">
        </div>
    </div>
    ...
    <div id="top-content" class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="header-graphic" src="{{assetPath file='graphic1.png'}|replace:'/png/':'/images/'}" alt="" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{assetPath file='service-icon1.svg'}|replace:'/svg/':'/images/'}" alt="">
                    </div>
...
atque corrupti quos dolores et quas molestias.</p>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{assetPath file='service-icon2.svg'}|replace:'/svg/':'/images/'}" alt="">
                    </div>
...
atque corrupti quos dolores et quas molestias.</p>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{assetPath file='service-icon3.svg'}|replace:'/svg/':'/images/'}" alt="">
                    </div>
...
atque corrupti quos dolores et quas molestias.</p>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{assetPath file='service-icon4.svg'}|replace:'/svg/':'/images/'}" alt="">
                    </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div id="features-links-holder">
                    <div class="icons-axis">
                        <img src="{{assetPath file='features-icon.png'}|replace:'/png/':'/images/'}" alt="">
                    </div>
                ...
                <div id="testimonials-slider">
                    <div>
                        <div class="details-holder">
                            <img class="photo" src="{{assetPath file='person1.jpg'}|replace:'/jpg/':'/images/'}" alt="">
                            <h4>Chris Walker</h4>
                    ...
                    <div>
                        <div class="details-holder">
                            <img class="photo" src="{{assetPath file='person2.jpg'}|replace:'/jpg/':'/images/'}" alt="">
                            <h4>Chris Walker</h4>
                            <h5>CEO & CO-Founder @HelloBrandio</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris egestas non ante non consequat. Aenean accumsan eros vel elit tristique, non sodales nunc luctus. Etiam vitae odio eget orci finibus auctor ut eget magna.</p>
                        </div>
