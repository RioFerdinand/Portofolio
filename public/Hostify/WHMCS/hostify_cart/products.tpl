                            ...
                            <div class="pricing-box pricing-box-simple pricing-color{$counter}{if $product.isFeatured} bestbuy{/if}" style="width: 100%">
                                <div class="pricing-content">
                                                        ...
                                                        <div class="pricing-options">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div id="monthly{$product@iteration}" class="tab-pane fade in active">
                                                                    <div class="pricing-price">{$mycurrency}{$product.pricing.rawpricing.monthly}
                                                                    </div>
                                                                ...
                                                                <div id="quarterly{$product@iteration}" class="tab-pane fade">
                                                                    <div class="pricing-price">{$mycurrency}{$product.pricing.rawpricing.quarterly}</div>
                                                                ...
                                                                <div id="semiannually{$product@iteration}" class="tab-pane fade">
                                                                    <div class="pricing-price">{$mycurrency}{$product.pricing.rawpricing.semiannually}</div>
                                                                ...
                                                                <div id="annualy{$product@iteration}" class="tab-pane fade">
                                                                    <div class="pricing-price">{$mycurrency}{$product.pricing.rawpricing.annually}</div>
                                                                ...
                                                                <div id="biennially{$product@iteration}" class="tab-pane fade">
                                                                    <div class="pricing-price">{$mycurrency}{$product.pricing.rawpricing.biennially}</div>
                                                                ...
                                                                <div id="triennially{$product@iteration}" class="tab-pane fade">
                                                                    <div class="pricing-price">{$mycurrency}{$product.pricing.rawpricing.triennially}</div>
                                    ...
                                    <div class="pricing-link">
                                        ...
                                        {else}
                                            <a class="ybtn" href="{$WEB_ROOT}/cart.php?a=add&amp;{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}" id="product{$product@iteration}-order-button">
                                                {$LANG.ordernowbutton}
                                            </a>
                                        {/if}
                                    </div>
